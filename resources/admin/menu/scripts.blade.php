...
<script type="text/javascript" src="{{ asset('public/admin/js/menu/scripts.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/admin/js/menu/scripts2.js') }}"></script>
